# Lesson 11: Three-Variable Linear Equations — Elimination Method
*Fundamental Math / Course 3*

Lesson 10 solved systems of two equations in two variables. This lesson extends the
...
one equation wasn't a solution in Lesson 10.
...
is exactly the system Lesson 10 already knows how to solve. In general this takes two
...
3. Eliminate $x$ from one pair, e.g. (1) and (2), using Lesson 10's elimination method.
   Call the result (4): an equation in $y$ and $z$ only.
4. Eliminate $x$ **again**, from a *different* pair — e.g. (1) and (3), or (2) and (3) —
   independently of Step 3, using Lesson 10's method a second time. Call the result (5):
   another equation in $y$ and $z$ only.
5. (4) and (5) form a two-variable system in $y$ and $z$. Solve it with Lesson 10's
...
the same way Lesson 10 scans a two-equation system — rather than trying to reuse a
...
Label the equations (1), (2), (3). Unlike the two-variable no-solution case (Lesson 10),
...
- A three-variable system reduces to a two-variable system by eliminating one variable
  **twice**, from two different pairs of the original three equations — each elimination
  is worked out independently, the way Lesson 10 handles any two-equation system.
...
Next: complete [11-homework-solving-linear-equations.md](./11-homework-solving-linear-equations.md)
to practice the two- and three-variable elimination methods.
