# Lesson 10: Two-Variable Linear Equations — Substitution and Elimination
...
- Substitution and elimination always agree on the answer — choose whichever avoids more
  ...
  together with their geometric interpretation in a later lesson.

Next lesson: [11-three-variable-linear-equations.md](./11-three-variable-linear-equations.md)
