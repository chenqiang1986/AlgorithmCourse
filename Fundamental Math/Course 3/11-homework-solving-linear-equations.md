# Homework: Lessons 10–11 — Solving Linear Equations
*Fundamental Math / Course 3*

This homework covers [10-two-variable-linear-equations.md](./10-two-variable-linear-equations.md)
(substitution, elimination, and choosing between them) and
[11-three-variable-linear-equations.md](./11-three-variable-linear-equations.md)
