...
def plot_precision_vs_recall(probabilities, actual_values, positive_label=1, ax=None, title="Precision VS Recall"):
    """Plot a ROC curve from positive-class probabilities and true labels.
    ...
    precision_rate, recall_rate, _ = precision_recall_curve(
        actual_values, probabilities, pos_label=positive_label
    )
